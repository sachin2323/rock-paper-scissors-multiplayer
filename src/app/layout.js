...
import { ALL_PLAYERS, GAME_DATA, PLAYER_ID_KEY } from "./lib/constants";
...
//   description: "Made with ❤️ by Sachin Singh",
// };
  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        {playerId && <Button onClick={handleLogout}>Logout</Button>}
        {children}
      </body>
    </html>
  );
